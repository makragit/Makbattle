...
class Psion(Sprite):
    ...
    def __init__(self, settings, all_groups):
        ...
        self.image = res.psion_png.convert()
        self.image_w = res.psion_w_png.convert()
        self.image_d = res.psion_d_png.convert()
        ...
        self.name = "Psion"
        self.type = 1
        self.accuracy = self.settings.accuracy_psion
        ...
        self.shoot_delay = self.settings.shoot_delay_psion
        self.last_update = randint(0, 500)
        self.army_side = "left"
    ...
    def flip_horizontal(self):
        ...
        self.image_w = pygame.transform.flip(self.image_w, True, False)
    ...
    def draw_blood_splatter(self):
        ...
        if self.blood_drawn == False:
            for i in range(self.settings.blood_splatter_count):
                ...
                blood_splatter.rect.x = (self.rect.x + (self.rect.width / 2)) + randint(-20, 20)
                blood_splatter.rect.y = (self.rect.y + self.rect.height) + randint(-20, 20)
                blood_splatter.radius = randint(2, 15)
                blood_splatter.color = pygame.Color(70, 70, 200)
